...
namespace Project.Scripts.Levels.MysteryPlanet.SecondLevel
{
    public class SecondMysteryPlanetLevel : Level
    {
        ...
        [field: SerializeField] public RadioTower RadioTower { get; private set; }
        ...
        private void OnDestroy()
        {
            ...
            RadioTower.ProgressChanged -= _missionProgressBar.OnChangedValues;
            ...
            RadioTower.InstallationDishCompleted -= DialogueSetter.OnEndAttack;
            RadioTower.InstallationDishCompleted -= ShowOutpostPointers;
            RadioTower.InstallationDishCompleted -= ArrowLookAtOutpost;
            RadioTower.InstallationDishCompleted -= _enemySpawnTriggerWithEffect.CompleteSpawn;
            RadioTower.InstallationDishCompleted -= EndLevelTrigger.Activate;
            RadioTower.InstallationDishCompleted -= EntranceToNextLvlTrigger.Activate;
            RadioTower.InstallationDishCompleted -= _entranceLastLvlTrigger.Activate;
            RadioTower.InstallationDishCompleted -= _radioTowerTrigger.Deactivate;
        }
