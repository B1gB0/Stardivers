...
namespace Project.Scripts.DataBase
{
    ...
    {
        [SpreadsheetPage("OperationsLocalization")]
        public List<OperationLocalizationData> OperationsLocalization;

        [SpreadsheetPage("CharacteristicsLocalization")]
        public List<CharacteristicsLocalizationData> CharacteristicsLocalization;

        [SpreadsheetPage("WeaponsLocalization")]
        public List<WeaponLocalizationData> WeaponsLocalization;

        [SpreadsheetPage("CharacteristicsWeapon")]
        public List<CharacteristicsWeaponData> CharacteristicsWeaponsData;
        ...
        [SpreadsheetPage("MysteryPlanetSceneLevels")]
        public List<SceneLevelData> MysteryPlanetSceneLevels;
